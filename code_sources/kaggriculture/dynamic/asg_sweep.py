...
def variants(base):
    ...
    return [
        ("angular sweep (base)", V()),
        ("hungarian", V(ASSIGN_MODE="hungarian")),
        ("greedy by deadline", V(ASSIGN_MODE="greedy")),
        ("hungarian + discount .5", V(ASSIGN_MODE="hungarian", CAPITAL_DISCOUNT=0.5)),
    ]
